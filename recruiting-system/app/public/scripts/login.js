...
$(function () {
  ...
  $("#login-btn").on('click', function (evt) {
    if (isPhoneEmail && isLoginPassword) {
      request.get('/login').set('Content-Type', "application/json").send({
